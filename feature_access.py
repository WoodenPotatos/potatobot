...
COMMAND_POLICIES = {
    ...
    "hilo": _command("casino_hilo"),
    "crash": _command("casino_crash"),
    "wheel": _command("casino_wheel"),
    "russian": _command("casino_russian"),
    "minigame_reset": _command("minigames"),
    ...
    "genshindle": _command("everydle_genshindle", ResponsePolicy.PRIVATE),
